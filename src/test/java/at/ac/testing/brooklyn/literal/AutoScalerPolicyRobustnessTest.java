...
public class AutoScalerPolicyRobustnessTest extends
	...
	public void testNeverShrinkBelowMinimum(int minSize, int maxSize,
		...
		resizable.emit(AutoScalerPolicy.DEFAULT_POOL_COLD_SENSOR,
				(new ThresholdBasedPolicy(lowerBound, upperBound)).resize(4, 0)
						.getSensorReading());
	...
	public void testNeverGrowAboveMaximmum(int minSize, int maxSize,
			int lowerBound, int upperBound) throws Exception {
		resizable.removePolicy(policy);
		policy = AutoScalerPolicy.builder().maxPoolSize(maxSize).build();
		resizable.addPolicy(policy);
	...
	public void testConcurrentShrinkShrink(int lowerBound, int upperBound)
		...
		resizable.emit(AutoScalerPolicy.DEFAULT_POOL_COLD_SENSOR,
				(new ThresholdBasedPolicy(lowerBound, upperBound)).resize(4, 1)
						.getSensorReading());
	...
	public void testConcurrentGrowGrow(int lowerBound, int upperBound)
		...
		resizable.emit(AutoScalerPolicy.DEFAULT_POOL_HOT_SENSOR,
				(new ThresholdBasedPolicy(lowerBound, upperBound)).resize(2, 5)
						.getSensorReading());
	...
	public void testConcurrentGrowShrink(int lowerBound, int upperBound)
		...
		resizable.emit(AutoScalerPolicy.DEFAULT_POOL_COLD_SENSOR,
				(new ThresholdBasedPolicy(lowerBound, upperBound)).resize(2, 1)
						.getSensorReading());
		// now expect pool to shrink to 1
	...
	public void testConcurrentShrinkGrow(int lowerBound, int upperBound)
		...
		resizable.emit(AutoScalerPolicy.DEFAULT_POOL_HOT_SENSOR,
				(new ThresholdBasedPolicy(lowerBound, upperBound)).resize(4, 5)
						.getSensorReading());
		// now expect pool to grow to 5
	...
	public void testResizeUpStabilizationDelayIgnoresBlip(int lowerBound,
		...
		resizable.emit(AutoScalerPolicy.DEFAULT_POOL_HOT_SENSOR,
				(new ThresholdBasedPolicy(lowerBound, upperBound)).resize(1, 4)
						.getSensorReading());
		// would
		// grow
		// to
		...
		resizable.emit(AutoScalerPolicy.DEFAULT_POOL_OK_SENSOR,
				(new ThresholdBasedPolicy(lowerBound, upperBound)).resize(1, 1)
						.getSensorReading());
		// but
		// 1
		// is
	...
	public void testResizeUpStabilizationDelayTakesMaxSustainedDesired(
			final int lowerBound, int upperBound) throws Exception {
		...
		// 4
		resizable.emit(AutoScalerPolicy.DEFAULT_POOL_HOT_SENSOR,
				(new ThresholdBasedPolicy(lowerBound, upperBound)).resize(1, 2)
						.getSensorReading());
		// would
		// grow
		// to
	...
	public void testResizeDownStabilizationDelayIgnoresBlip(int lowerBound,
		...
		resizable.emit(AutoScalerPolicy.DEFAULT_POOL_OK_SENSOR,
				(new ThresholdBasedPolicy(lowerBound, upperBound)).resize(2, 2)
						.getSensorReading());
		// but
		// 2
		// is
	...
	public void testResizeDownStabilizationDelayTakesMinSustainedDesired(
		...
		resizable.emit(AutoScalerPolicy.DEFAULT_POOL_COLD_SENSOR,
				(new ThresholdBasedPolicy(lowerBound, upperBound)).resize(3, 1)
						.getSensorReading());
		// would
		// shrink
		// to
		// 1
		resizable.emit(AutoScalerPolicy.DEFAULT_POOL_COLD_SENSOR,
				(new ThresholdBasedPolicy(lowerBound, upperBound)).resize(3, 2)
						.getSensorReading());
		// would
		// shrink
		// to
