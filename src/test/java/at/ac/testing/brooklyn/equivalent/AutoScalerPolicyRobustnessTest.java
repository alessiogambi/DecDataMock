...
public class AutoScalerPolicyRobustnessTest extends
	...
	public void testShrinkColdPool(int lowerBound, int upperBound)
		...
		resizable.emit(AutoScalerPolicy.DEFAULT_POOL_COLD_SENSOR,
				(new ThresholdBasedPolicy(lowerBound, upperBound)).resize(4, 3)
						.getSensorReading());
	...
	public void testShrinkColdPoolRoundsUpDesiredNumberOfContainers(
		...
		resizable.emit(AutoScalerPolicy.DEFAULT_POOL_COLD_SENSOR,
				(new ThresholdBasedPolicy(lowerBoundResourceThrashing,
						upperBoundResourceThrashing)).resize(4, 1)
						.getSensorReading());
	...
	public void testGrowHotPool(int lowerBound, int upperBound)
		...
		resizable.emit(AutoScalerPolicy.DEFAULT_POOL_HOT_SENSOR,
				(new ThresholdBasedPolicy(lowerBound, upperBound)).resize(2, 3)
						.getSensorReading());
	...
	public void testNeverShrinkBelowMinimum(int minSize, int maxSize,
		...
		resizable.resize(maxSize);

		resizable.emit(
				AutoScalerPolicy.DEFAULT_POOL_COLD_SENSOR,
				(new ThresholdBasedPolicy(lowerBound, upperBound)).resize(
						maxSize, minSize - 1).getSensorReading());
	...
	public void testNeverGrowAboveMaximmum(int minSize, int maxSize,
		...
		resizable.emit(
				...
				(new ThresholdBasedPolicy(lowerBound, upperBound)).resize(4,
						maxSize + 1).getSensorReading());
	...
	public void testNeverGrowColdPool(int lowerBound, int upperBound)
		...
		resizable.emit(AutoScalerPolicy.DEFAULT_POOL_COLD_SENSOR,
				(new ThresholdBasedPolicy(lowerBound, upperBound))
						.resize(2, 50).getSensorReading());
	...
	public void testNeverShrinkHotPool(int lowerBound, int upperBound)
		...
		resizable.emit(AutoScalerPolicy.DEFAULT_POOL_HOT_SENSOR,
				(new ThresholdBasedPolicy(lowerBound, upperBound)).resize(2, 0)
						.getSensorReading());
	...
	public void testConcurrentShrinkShrink(int lowerBound, int upperBound)
		...
		final Map<String, Object> resize_from_4_to_3 = (new ThresholdBasedPolicy(
				lowerBound, upperBound)).resize(4, 3).getSensorReading();
		final Map<String, Object> resize_from_4_to_1 = (new ThresholdBasedPolicy(
				lowerBound, upperBound)).resize(4, 1).getSensorReading();
	...
	public void testConcurrentGrowGrow(int lowerBound, int upperBound)
		...
		final Map<String, Object> resize_from_2_to_3 = (new ThresholdBasedPolicy(
				lowerBound, upperBound)).resize(2, 3).getSensorReading();
		final Map<String, Object> resize_from_2_to_5 = (new ThresholdBasedPolicy(
				lowerBound, upperBound)).resize(2, 5).getSensorReading();
	...
	public void testConcurrentGrowShrink(int lowerBound, int upperBound)
		...
		final Map<String, Object> resize_from_2_to_1 = (new ThresholdBasedPolicy(
				lowerBound, upperBound)).resize(2, 1).getSensorReading();
	...
	public void testConcurrentShrinkGrow(int lowerBound, int upperBound)
		...
		final Map<String, Object> resize_from_4_to_5 = (new ThresholdBasedPolicy(
				lowerBound, upperBound)).resize(4, 5).getSensorReading();
	...
	public void testResizeUpStabilizationDelayIgnoresBlip(int lowerBound,
		...
		final Map<String, Object> resize_from_1_to_4 = (new ThresholdBasedPolicy(
				lowerBound, upperBound)).resize(1, 4).getSensorReading();
		final Map<String, Object> stay_at_1 = (new ThresholdBasedPolicy(
				lowerBound, upperBound)).resize(1, 1).getSensorReading();
	...
	public void testResizeUpStabilizationDelayTakesMaxSustainedDesired(
		...
		final Map<String, Object> resize_from_1_to_2 = (new ThresholdBasedPolicy(
				lowerBound, upperBound)).resize(1, 2).getSensorReading();
	...
	public void testResizeUpStabilizationDelayResizesAfterDelay(int lowerBound,
		...
		final Map<String, Object> need4 = (new ThresholdBasedPolicy(lowerBound,
				upperBound)).resize(1, 4).getSensorReading();
	...
	public void testResizeDownStabilizationDelayIgnoresBlip(int lowerBound,
		...
		final Map<String, Object> resize_from_2_to_1 = (new ThresholdBasedPolicy(
				lowerBound, upperBound)).resize(2, 1).getSensorReading();
		final Map<String, Object> stay_at_2 = (new ThresholdBasedPolicy(
				lowerBound, upperBound)).resize(2, 2).getSensorReading();
	...
	public void testResizeDownStabilizationDelayTakesMinSustainedDesired(
		...
		final Map<String, Object> resize_from_3_to_1 = (new ThresholdBasedPolicy(
				lowerBound, upperBound)).resize(3, 1).getSensorReading();
		final Map<String, Object> resize_from_3_to_2 = (new ThresholdBasedPolicy(
				lowerBound, upperBound)).resize(3, 2).getSensorReading();
	...
	public void testResizeDownStabilizationDelayResizesAfterDelay(
		...
		// After suitable delay, grows to desired
		final long emitTime = System.currentTimeMillis();
		final Map<String, Object> needJust1 = (new ThresholdBasedPolicy(
				lowerBound, upperBound)).resize(2, 1).getSensorReading();
